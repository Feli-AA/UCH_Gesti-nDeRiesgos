...
\small La clínica debe superponer capas: (1) identidad y MFA; (2) protección de endpoints, correo, red y monitoreo; y (3) respaldos inmutables probados, continuidad operativa y respuesta a incidentes. Si una capa falla, las restantes contienen el daño. \textit{(Referencia del material de la consigna: la solidez progresiva de las casas de los tres cerditos como analogía de controles en capas.)}

\priority{4}{teal!25}{Reforzar la protección frente a amenazas externas y suplantación.}
\small El phishing que imita a una obra social o proveedor puede ocultar la identidad del atacante y explotar la confianza del personal. Se recomiendan MFA, validación por canal alternativo, filtrado de correo y capacitación práctica. \textit{(Referencia del material de la consigna: el lobo y Caperucita Roja como analogía de engaño y suplantación.)}

\priority{5}{medium!85}{Proteger la infraestructura física y su ubicación.}
\small La sala técnica debe estar separada de fuentes de incendio, calor y agua, e incorporar sensores ambientales, detección de humo y filtraciones, UPS/generador probado y control de acceso. \textit{(Referencia del material de la consigna: evitar ubicar el centro de datos junto a cocinas o debajo de piletas.)}
