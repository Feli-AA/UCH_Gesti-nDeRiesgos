...
| Evidencia | Archivo |
|---|---|
| Riesgo R01 — Ransomware sobre historias clínicas digitales | `riesgo_R01_ransomware.png` |
| Riesgo R02 — Acceso no autorizado a historias clínicas | `riesgo_R02_acceso_no_autorizado.png` |
| Riesgo R03 — Falla o pérdida de copias de seguridad | `riesgo_R03_backups.png` |
| Riesgo R04 — Caída del sistema de gestión clínica | `riesgo_R04_caida_sistema.png` |
| Riesgo R05 — Phishing dirigido al personal | `riesgo_R05_phishing.png` |
| Riesgo R06 — Modificación incorrecta de información médica | `riesgo_R06_modificacion_datos.png` |
| Riesgo R07 — Filtración de datos de pacientes y obras sociales | `riesgo_R07_filtracion_datos.png` |
| Plan de mitigación R01 — Ransomware | `mitigacion_R01_ransomware.png` |
| Plan de mitigación R03 — Copias de seguridad | `mitigacion_R03_backups.png` |
| Plan de mitigación R04 — Caída del sistema | `mitigacion_R04_caida_sistema.png` |
